...
data_series arg should be a map of dates to values.
"""
...
class EpidemicWave:
    def __init__(self, data_series, **opts):
    ...
    @cached_property
    def dates(self):
        return sorted(self.data_series.keys())
    ...
    def windows(self):
        ...
        for dated in self.dates:
            ...
            for n in range(-half_window_len, half_window_len+1):
                ...
                rate = self.data_series.get(rate_date)
                if rate:
