...
class OcController(Controller):
    ...
    def dev(self):
        ...
        print('windows', len(analysis.wave.windows))
        print('phases', len(analysis.wave.phases))
        print('smooth_phases', len(analysis.wave.smoothed_phases))

        #breakpoint()

        pprint(analysis.wave.smoothed_phases)
