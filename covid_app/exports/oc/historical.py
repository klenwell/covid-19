...
The export is meant to be run nightly. It provides a daily snapshot of Covid data reports.
The data primarily comes from the OC Health Care Agency API.
